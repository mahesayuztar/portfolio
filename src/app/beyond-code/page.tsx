...
const beyondCodeImages = [
  { src: mahesaRoboticsImage, alt: "Mahesa Yuztar" },
  { src: bridge3Image, alt: "Mahesa Yuztar" },
  { src: robotics1Image, alt: "Mahesa Yuztar" },
  { src: pln1Image, alt: "Mahesa Yuztar" },
  // { src: bridge1Image, alt: "Mahesa Yuztar" },
  { src: robotics5Image, alt: "Mahesa Yuztar" },
  { src: uitmImage, alt: "Mahesa Yuztar" },
  { src: bridge4Image, alt: "Mahesa Yuztar" },
  { src: robotics2Image, alt: "Mahesa Yuztar" },
  { src: pln2Image, alt: "Mahesa Yuztar" },
  // { src: bridge5Image, alt: "Mahesa Yuztar" },
  { src: robotics6Image, alt: "Mahesa Yuztar" },
  { src: bridge2Image, alt: "Mahesa Yuztar" },
  { src: robotics3Image, alt: "Mahesa Yuztar" },
  { src: robotics7Image, alt: "Mahesa Yuztar" },
  { src: bridge6Image, alt: "Mahesa Yuztar" },
  // { src: robotics4Image, alt: "Mahesa Yuztar" },
  { src: robotics8Image, alt: "Mahesa Yuztar" },
];
