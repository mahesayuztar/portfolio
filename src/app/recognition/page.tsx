      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto w-[min(100%-40px,1180px)]">
          ...
          <div className="mt-14 grid gap-10 lg:grid-cols-[1fr_0.6fr] lg:items-end">
            <CursorRevealHeading className="mt-5 max-w-4xl text-balance text-[clamp(3.5rem,9vw,6rem)] font-medium leading-[0.84] tracking-[-0.065em]">Results, and the work behind them.</CursorRevealHeading>
          </div>
        </div>
      </section>
